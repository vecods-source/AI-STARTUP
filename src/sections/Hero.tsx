  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="w-[344px] h-[344px] md:w-[580px] md:h-[580px] border border-white opacity-10 absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 rounded-full"
      >
      ...
      <motion.div
        ...
        transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
        style={{ translateX: "-50%", translateY: "-50%" }}
        className="w-[444px] h-[444px] md:h-[780px] md:w-[780px] border border-dashed border-white opacity-15 absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 rounded-full"
      ></motion.div>
      <motion.div
        animate={{ rotate: "1turn" }}
        transition={{ duration: 90, repeat: Infinity, ease: "linear" }}
        style={{ translateX: "-50%", translateY: "-50%" }}
        className="w-[544px] h-[544px] md:h-[980px] md:w-[980px] border border-white opacity-15 absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 rounded-full"
      >
        <div className="w-2 h-2 rounded-full bg-white absolute top-1/2 -left-0 -translate-x-1/2 -translate-y-1/2"></div>
